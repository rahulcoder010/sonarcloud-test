...
undeclaredVar = 'This variable is not declared';
...
function noStrictMode() {
    "use strict";
    undeclaredStrictVar = 100; // This should throw an error but won't due to improper placement
}
...
function shadowExample() {
    let shadowVar = 20;
    console.log(shadowVar); // Shadows the outer shadowVar
}
